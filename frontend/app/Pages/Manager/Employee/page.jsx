...
//                         <button
//                           onClick={() => setAccessEmployee(selectedEmployee)} // Pass selectedEmployee here
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col gap-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h1 className="text-3xl font-bold text-[#1a2b42]">Employee Management</h1>
                  <p className="text-[#5a6a7e] mt-1">Manage your team members and their roles</p>
                </div>
                <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                  ...
                  <DialogContent className="sm:max-w-[425px] bg-white rounded-xl border border-[#e2f0f9]">
                    <DialogHeader>
                      <DialogTitle className="text-[#1a2b42] text-xl">Add New Employee</DialogTitle>
                    ...
                    <div className="flex justify-end gap-3">
                      ...
                      <Button className="bg-[#236294] text-white hover:bg-[#1a4b70]" onClick={handleAddEmployee}>
                        <Plus className="mr-2 h-4 w-4" />
                        Add Employee
                      </Button>
                    </div>
                ...
                <AnimatePresence>
                  ...
                  >
                    <div className="bg-white p-8 rounded-xl shadow-2xl max-w-lg w-full space-y-6 border border-[#e2f0f9]">
                      <div className="flex justify-between items-center mb-6">
                        <h2 className="text-2xl font-semibold text-[#1a2b42]">Employee Details</h2>
                        <button
                          onClick={() => setSelectedEmployee(null)}
                      ...
                      <div className="space-y-4 bg-[#f8fbff] p-4 rounded-lg border border-[#e2f0f9]">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                          <div className="flex items-start">
                            ...
                            <div className="text-[#1a2b42] font-medium">{selectedEmployee.email}</div>
                          </div>
                          <div className="flex items-start">
                            <div className="w-24 text-[#5a6a7e] text-sm">Phone:</div>
                            <div className="text-[#1a2b42] font-medium">{selectedEmployee.phoneNumber}</div>
                          </div>
                          <div className="flex items-start">
                            <div className="w-24 text-[#5a6a7e] text-sm">Address:</div>
                            <div className="text-[#1a2b42] font-medium">{selectedEmployee.address}</div>
                          </div>
                          <div className="flex items-start">
              ...
              {accessEmployee && (
                <Dialog open={!!accessEmployee} onOpenChange={() => setAccessEmployee(null)}>
                  <DialogContent className="bg-white rounded-xl border  border-[#e2f0f9] shadow-xl">
                    ...
                    <div className="flex justify-end gap-3 mt-4">
                      ...
                      <Button className="bg-[#4caf50] text-white hover:bg-[#43a047]" onClick={handleRegisterEmployee}>
                        Grant Access
                      </Button>
                    </div>
                  </DialogContent>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <AnimatePresence>
                  {filteredEmployees.map((employee) => (
                    <motion.div key={employee.id} variants={item} initial="hidden" animate="show" exit="hidden" layout>
