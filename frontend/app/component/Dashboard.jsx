...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    fetchBatches()
  }, []) // Removed fetchBatches from the dependency array
    ...
    <div className="flex h-screen w-full bg-gray-50">
      ...
      >
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <h2 className="text-2xl font-bold text-[#121828] mb-6 border-b-2 border-blue-200 pb-2">Batches</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {batches.map((batch, index) => (
              ...
              >
                <h3 className="text-xl font-bold text-[#121828] mb-2">{batch.batchId}</h3>
                <div className="space-y-2 mb-4">
                  ...
                  <p className="text-gray-600">
                    <span className="font-medium">Process:</span> {batch.currentProcess}
                  </p>
                </div>
                <button
